...
t resource =
  case resource of
    ...
    RValErrNonReferenceInvalid -> "für den Typ NON darf keine Referenz existieren"
    RValErrNonReferenceWithQrIban -> "der Typ NON kann nicht für mit einem QR-Iban verwendet werden"
    RValErrCreditorReferenceWithQrIban -> "der Typ SCOR kann nicht für mit einem QR-Iban verwendet werden"
