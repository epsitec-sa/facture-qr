...
var _epsitec_sa$facture_qr$Native_LocalStorage = (function () {
  ...
  function get (key) {
    return nativeBinding (function (callback) {
      ...
      return callback (succeed (value === null ? Nothing : Just (value)));
    });
  }
  ...
  var keys = nativeBinding (function (callback) {
    ...
    return callback (succeed (_elm_lang$core$Native_List.fromArray (_keys)));
  });
